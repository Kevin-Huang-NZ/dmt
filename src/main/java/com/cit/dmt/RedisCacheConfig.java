...
import com.cit.dmt.handler.IgnoreExceptionCacheErrorHandler;
...
public class RedisCacheConfig extends CachingConfigurerSupport {
	...
	public CacheManager cacheManager() {
		...
		RedisCacheManager cacheManager = RedisCacheManager
				...
				.withInitialCacheConfigurations(singletonMap("dmt-app", RedisCacheConfiguration.defaultCacheConfig()
	...
	public RedisTemplate<Object, Object> redisTemplate() {
		...
		// 建议使用这种方式，小范围指定白名单
		ParserConfig.getGlobalInstance().addAccept("com.cit.dmt.core.service.models.");
