<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="originalAbbr" align="center">
        <template slot-scope="{row}">
          <span>{{ row.originalAbbr }}</span>
        </template>
      </el-table-column>
      <el-table-column label="originalType" align="center">
        <template slot-scope="{row}">
          <span>{{ row.originalType }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="transliteration" align="center">
        <template slot-scope="{row}">
          <span>{{ row.transliteration }}</span>
        </template>
      </el-table-column>
      <el-table-column label="freeTranslation" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:50px;margin-right:50px;">
        ...
        <el-form-item label="originalAbbr" prop="originalAbbr">
          <el-input v-model="temp.originalAbbr" />
        </el-form-item>
        <el-form-item label="originalType" prop="originalType">
          <el-input v-model="temp.originalType" />
        </el-form-item>
...
<script>
import { listCtCommon, getCtCommon, createCtCommon, updateCtCommon, deleteCtCommon } from '@/api/sys'
