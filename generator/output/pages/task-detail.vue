<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.taskId" placeholder="" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="gec" align="center">
        <template slot-scope="{row}">
          <span>{{ row.gec }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="romanStatus" align="center">
        <template slot-scope="{row}">
          <span>{{ row.romanStatus }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="transStatus" align="center">
        <template slot-scope="{row}">
          <span>{{ row.transStatus }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="transResult" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:50px;margin-right:50px;">
        ...
        <el-form-item label="gec" prop="gec">
...
<script>
import { listTaskDetail, getTaskDetail, createTaskDetail, updateTaskDetail, deleteTaskDetail } from '@/api/sys'
