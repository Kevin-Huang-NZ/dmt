<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="roundName" align="center">
        <template slot-scope="{row}">
...
<script>
import { listCheckRound, getCheckRound, createCheckRound, updateCheckRound, deleteCheckRound } from '@/api/sys'
