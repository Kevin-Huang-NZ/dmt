<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.languageName" placeholder="" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="languageName" align="center">
        <template slot-scope="{row}">
          <span>{{ row.languageName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="isRoman" align="center">
        <template slot-scope="{row}">
          <span>{{ row.isRoman }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:50px;margin-right:50px;">
        ...
        <el-form-item label="languageName" prop="languageName">
          <el-input v-model="temp.languageName" />
        </el-form-item>
        <el-form-item label="isRoman" prop="isRoman">
          <el-input v-model="temp.isRoman" />
        </el-form-item>
