<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.roleName" placeholder="" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
<script>
import { listSysRole, getSysRole, createSysRole, updateSysRole, deleteSysRole } from '@/api/sys'
