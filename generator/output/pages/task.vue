<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="needRoman" align="center">
        <template slot-scope="{row}">
          <span>{{ row.needRoman }}</span>
        </template>
      </el-table-column>
      <el-table-column label="createDate" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:50px;margin-right:50px;">
        ...
        <el-form-item label="needRoman" prop="needRoman">
          <el-input v-model="temp.needRoman" />
        </el-form-item>
        <el-form-item label="createDate" prop="createDate">
          <el-input v-model="temp.createDate" />
        </el-form-item>
...
<script>
import { listTask, getTask, createTask, updateTask, deleteTask } from '@/api/sys'
