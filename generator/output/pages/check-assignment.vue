<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="done" align="center">
        <template slot-scope="{row}">
          <span>{{ row.done }}</span>
        </template>
      </el-table-column>
      <el-table-column label="assignStatus" align="center">
        <template slot-scope="{row}">
          <span>{{ row.assignStatus }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:50px;margin-right:50px;">
        ...
        <el-form-item label="done" prop="done">
          <el-input v-model="temp.done" />
        </el-form-item>
        <el-form-item label="assignStatus" prop="assignStatus">
          <el-input v-model="temp.assignStatus" />
        </el-form-item>
...
<script>
import { listCheckAssignment, getCheckAssignment, createCheckAssignment, updateCheckAssignment, deleteCheckAssignment } from '@/api/sys'
