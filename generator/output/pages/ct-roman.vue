<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="originalAlpha" align="center">
        <template slot-scope="{row}">
          <span>{{ row.originalAlpha }}</span>
        </template>
      </el-table-column>
      <el-table-column label="romanAlpha" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:50px;margin-right:50px;">
        ...
        <el-form-item label="originalAlpha" prop="originalAlpha">
          <el-input v-model="temp.originalAlpha" />
        </el-form-item>
        <el-form-item label="romanAlpha" prop="romanAlpha">
...
<script>
import { listCtRoman, getCtRoman, createCtRoman, updateCtRoman, deleteCtRoman } from '@/api/sys'
